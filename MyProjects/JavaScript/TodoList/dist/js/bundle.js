...
var todoForm = document.querySelector('.form__todo'),
...
var dragHandlerFunc = function dragHandlerFunc(listIndex) {
  return dragHandler(listIndex);
};

function dragHandler(listIndex) {
  document.querySelector("#list-item".concat(listIndex)).addEventListener('dragstart', handleDragStart, false);
...
function handleDrop(e) {
  ...
  if (dragData != this) {
    ...
    _toConsumableArray(document.querySelectorAll('.list-item')).map(function (v) {
      console.log(v.id);
    });

    console.log(parsedTodoList); // parsedTodoList.map((v)=>{
    //     console.log(v)
    // })
  }
}
...
/***/ 0:
/*!****************************************************************!*\
  !*** multi @babel/polyfill ./src/js/app.js ./src/css/app.scss ***!
  \****************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
